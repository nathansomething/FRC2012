...
/*Processes an image that is passed through this function. It detects the bounding box of the backboard and returns that data through the IVA_data object.
 *It is the responsibility of the user to call the IVA_DisposeData function after the data has been processed.*/
